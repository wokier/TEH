...
public class TEHUtilsTest {
	...
	public void testHashCodeObject() {
		assertEquals(TEHUtils.hashCode(new Pojo(1)),
				TEHUtils.hashCode(new Pojo(1)));
		assertTrue(TEHUtils.hashCode(new Pojo(1)) != TEHUtils
				.hashCode(new Pojo(2)));
	}
	...
	public void testHashCodePonderateFields() {
		assertTrue(TEHUtils.hashCode(new SubPojo(1, 2)) != TEHUtils
				.hashCode(new SubPojo(2, 1)));
	}

	@Test
	public void testHashCodeWithoutAttributeFallBackToDefaultImpl() {
		assertTrue(TEHUtils.hashCode(new PojoWithoutAttribute()) != TEHUtils
				.hashCode(new PojoWithoutAttribute()));
	}

	@Test
	public void testPrivateAttributeToStringWarn() {
		assertFalse(TEHUtils.toString(new PojoWithPrivateAttribute("priv"))
				.contains("IllegalAccessException"));
	}

	@Test
	public void testPrivateAttributeEqualsWarn() {
		assertTrue(TEHUtils.equals(new PojoWithPrivateAttribute("priv"),
				new PojoWithPrivateAttribute("priv")));
	}

	@Test
	public void testPrivateAttributeHashCodeWarn() {
		assertEquals(TEHUtils.hashCode(new PojoWithPrivateAttribute("priv")),
				TEHUtils.hashCode(new PojoWithPrivateAttribute("priv")));
	}
}
